...
public class VibratorHW {
    ...
    private static String V_PATH = "/sys/class/timed_output/vibrator/voltage_level";
    ...
    public static boolean setIntensity(int intensity)  {
        return FileUtils.writeLine(V_PATH, String.valueOf(intensity));
    }
    ...
    public static int getCurIntensity()  {
         return Integer.parseInt(FileUtils.readOneLine(V_PATH));
    }
