...
public class AdaptiveBacklight {
    ...
    private static String CABC_PATH = "/sys/class/graphics/fb0/cabc";
    ...
    public static boolean isSupported() {
        return FileUtils.isFileWritable(CABC_PATH);
    }
    ...
    public static boolean isEnabled() {
        return Boolean.parseBoolean(FileUtils.readOneLine(CABC_PATH));
    }
    ...
    public static boolean setEnabled(boolean status) {
        return FileUtils.writeLine(CABC_PATH, status ? "1" : "0");
    }
}
