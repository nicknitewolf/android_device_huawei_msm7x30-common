...
{
    mSensors[aps_12d_light] = new LightSensor();
    mPollFds[aps_12d_light].fd = mSensors[aps_12d_light]->getFd();
    mPollFds[aps_12d_light].events = POLLIN;
    mPollFds[aps_12d_light].revents = 0;

    mSensors[aps_12d_proximity] = new ProximitySensor();
