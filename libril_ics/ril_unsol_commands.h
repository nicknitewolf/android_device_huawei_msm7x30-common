...
*/
    ...
    {0, responseVoid, DONT_WAKE}, /* RIL_UNSOL_RESPONSE_TETHERED_MODE_STATE_CHANGED */
    {0, responseVoid, DONT_WAKE}, /* RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED */
    ...
    {0, responseVoid, DONT_WAKE}, /* RIL_UNSOL_QOS_STATE_CHANGED_IND */
